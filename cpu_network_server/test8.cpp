...
int main(int argc, char *argv[]) {
    ...
    fs_create("user1", "/dir/file9", 'f');

    fs_delete("user1", "/dir/file");
    fs_delete("user1", "/dir/file2");
    fs_delete("user1", "/dir/file3");
    fs_delete("user1", "/dir/file4");
    fs_delete("user1", "/dir/file5");
    fs_delete("user1", "/dir/file6");
    fs_delete("user1", "/dir/file7");
    fs_delete("user1", "/dir/file8");
